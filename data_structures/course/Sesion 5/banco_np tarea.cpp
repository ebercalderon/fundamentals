//cola en un Banco
//Existen dos tipos de colas para la atención
//1. Clientes
//2. Visitantes
...
int main(){
	...
	int operacion,cont;
	char tipoCliente,dato,nombre[100];
	cont=0;
	do{
	cout<<endl;
	...
	if(operacion==1){
		...
		cin>>dato;
		cout<<"Escribir nombre del cliente"<<endl;
		cin>>nombre;		
		if(tipoCliente=='c')
		...
		colaCliente.imprimir();cout<<"Cliente a pasar: "<<nombre<<". Tipo de cliente: "<<tipoCliente<<endl;
